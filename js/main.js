...
function attachGlobalLogoutButton(){
  ...
  btn.style.cssText = 'position:fixed;top:62px;left:10px;z-index:960;';
  ...
  logBtn.style.cssText = 'position:fixed;top:62px;left:70px;z-index:960;';
