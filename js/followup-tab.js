...
const TREATMENT_STAGES = [
  {id:'canine_retraction', label:'Canine Retraction'},
  {id:'incisors_retraction', label:'Incisors Retraction'},
  ...
  {id:'midline_correction', label:'Midline Correction'}
];
const MIDLINE_STAGE_ID = 'midline_correction';
