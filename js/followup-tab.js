  ...
  return `
    <div class="month-entry" data-entry-id="${e.id}">
      ...
      <div class="row" style="margin-bottom:8px;">
        <button type="button" class="secondary small wire-accessories-btn" data-id="${e.id}">🔧 واير / أكسسوارات</button>
      </div>
      ${usedList ? `<div class="stage-tags" style="margin-bottom:8px;">${usedList}</div>` : `<div class="placeholder" style="padding:8px;">لسه مفيش خصم — دوس "واير / أكسسوارات" فوق، أو اكتب كلمة زي "rebonding 11" أو "bracket roth" في خانة "اللي اتعمل" وهيتعرف عليها لوحده</div>`}
    </div>
  `;
}
