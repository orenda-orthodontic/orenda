...
async function scanAndDeductKeywords(entryId, text){
  ...
  // NOTE: wires used to be auto-detected from free text here (e.g. "wire 0.014"). That moved to
  // the explicit Wire/Accessories picker (see wire-accessories-modal.js) so a doctor phrasing it
  // differently than the regex expects can't silently skip the deduction. Bonding Upper's fixed
  // 0.012 wire deduction is unrelated to this and still happens automatically (bonding-newcase.js).
