...
function ensureDiagPhotoDock(){
  ...
  if(!dock){
    ...
    dock.style.cssText = 'position:fixed;bottom:20px;right:20px;width:230px;max-height:64vh;background:var(--panel);border:1px solid var(--border);border-radius:12px;box-shadow:0 4px 18px rgba(0,0,0,.35);z-index:950;display:flex;flex-direction:column;overflow:hidden;';
