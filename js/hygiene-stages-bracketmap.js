...
function ensureToothShapeStyles(){
  ...
  st.textContent = `
    ...
    /* الشاشة المدموجة: خريطة الفصوص هي الجزء الأكبر (٧٠٪) + المتابعة الشهرية جنبها (٣٠٪) */
    .monthly-split{display:grid;grid-template-columns:minmax(0,3fr) minmax(0,7fr);gap:16px;align-items:start;}
